#
# operating model M6: Tuna, Dome shape, Length-dependent
#-----------------------------------------------------
#---------------------------------------------------
...
sel=c(mat_func(30,40,len_mid[1:13]),mat_func(120,90,len_mid[14:23])) # dome shape double logistic equation
plot(sel,type="l")
#-------------------------------------------------------------------------------------------------
# start the simulation
setwd("E:\\simulation study\\operating models\\M6")
