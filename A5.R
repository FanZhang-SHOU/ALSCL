# stock assessment using ALSCL for operating model 5
library(TMB)
setwd("E:\\simulation study\\assessment models\\ALSCL")
# compile("ALSCL.cpp")
compile(file = "ALSCL.cpp", "&> /tmp/logfile.log")

for(iter in c(1,44,48,71,74,85))
{
  setwd("E:\\simulation study\\operating models\\M5")
  ...
  setwd("E:\\simulation study\\assessment models\\ALSCL\\A5")
