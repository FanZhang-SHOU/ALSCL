# stock assessment using ACL for M2
library(TMB)
...
for(iter in 30:100){
  ...
  parameters = list(
    ...
    dev_log_F = array(0,c(sim.data$nage,sim.data$nyear)),
  ...
  setwd("E:\\simulation study\\assessment models\\ACL\\A2")
