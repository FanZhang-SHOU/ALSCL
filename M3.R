#
# operating model M3: Flatfish, dome-shape, Length-dependent
#-----------------------------------------------------
#---------------------------------------------------
# define functions
...
sel=c(mat_func(30,35,len_mid[1:15]),mat_func(50,40,len_mid[16:23])) # dome shape double logistic equation
